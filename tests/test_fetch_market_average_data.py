...
class TestFetchMarketAverageData(unittest.TestCase):
    ...
    @patch("etl.jobs.fetch_market_index_data.fetch_market_index_data.get_existing_market_index_data")
    @patch("etl.jobs.fetch_market_index_data.fetch_market_index_data.publish_market_index_data_update_complete")
    @patch("etl.jobs.fetch_market_index_data.fetch_market_index_data.get_closest_us_market_closing_time", return_value=datetime.datetime(2025, 4, 16, 20, 0, 0))
